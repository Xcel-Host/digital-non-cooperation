  ...
  return (
    <div className="max-w-6xl mx-auto px-4">
      ...
      <div className="mb-8">
        ...
        <p className="text-xs text-[#aaa] mb-4">Choose alternatives. Reduce monopoly power.</p>
        ...
        >
          ...
          <div className="flex justify-between px-4 py-2" style={{ background: '#161616' }}>
            <span className="text-xs font-bold text-[#aaa] uppercase tracking-widest">Avoid</span>
            <span className="text-xs font-bold text-[#aaa] uppercase tracking-widest">Try This Instead</span>
          </div>
          ...
          {quickAlts.map((a, i) => (
            ...
            >
              <div className="flex items-center gap-2 flex-1">
                ...
                <span className="text-xs font-semibold text-[#aaa] line-through" style={{ textDecorationColor: '#2e0f0f' }}>
                  {a.avoid}
                </span>
              </div>
      ...
      <div className="mb-8">
        ...
        <p className="text-xs text-[#aaa] mb-4">You don't need to protest. Just make better choices.</p>
        ...
        <p className="text-xs text-[#aaa]">Withdraw your money. Withdraw your attention. Power will shift.</p>
      </div>

      {/* STEP 5: PARTICIPATE */}
      <div className="mb-8">
        <h2 className="text-lg font-black tracking-tight text-offwhite mb-1">Step 5: Participate</h2>
        <p className="text-xs text-[#aaa] mb-4">Join thousands taking silent action.</p>
      ...
      <div className="mb-8">
        ...
        <p className="text-xs text-[#aaa] mb-3">Non-violence. Non-cooperation. Non-surrender.</p>
        <div
        ...
        <Link to="/wealth"
          ...
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="text-right flex-shrink-0">
              ...
              <div className="text-xs text-[#aaa]">Ambani growth</div>
              <div className="text-xl font-black text-amber mt-1">1,535%</div>
              <div className="text-xs text-[#aaa]">Adani growth</div>
            </div>
          </div>
      ...
      <div className="mb-8">
        <div className="p-5 rounded-xl" style={{ background: '#111', border: '0.5px solid #1e1e1e' }}>
          <p className="text-xs font-bold text-[#aaa] uppercase tracking-widest mb-3">Coming Soon</p>
            ...
            {[
              ...
              <div key={e.name} className="flex items-center gap-3 py-2"
                ...
                <div>
                  ...
                  <span className="text-xs text-[#aaa] ml-2">{e.note}</span>
                </div>
                <span className="ml-auto text-xs text-[#aaa]">Soon</span>
              </div>
            ))}
          </div>
        </div>
