  ...
  sectors: [
    ...
    },
    {
      ...
      brands: [
        ...
        { name: 'Toni & Guy / Brylcreem', detail: 'Global beauty brands · Reliance Consumer Products acquired global rights Jan 2026 · Source: Indiatimes, Jan 17 2026' },
        { name: 'Sikhya Entertainment', detail: 'Film pre/post-production · Acquired by Reliance Industries Feb 2026 · Source: Tracxn / SMEStreet, Feb 2026' },
      ],
      alternatives: [{
    ...
    },
    {
      ...
      name: 'FMCG & Beverages',
      count: '6 brands',
      description: 'Reliance bought Campa Cola for ₹22 crore in 2022 and relaunched it aggressively. Sosyo is a Gujarat-based drink with Reliance holding 50%. Manna (health foods) acquired Feb 2026.',
      brands: [
        { name: 'Campa Cola', detail: 'Cola drink · Reliance Consumer Products · ₹22Cr acquisition 2022 · Source: Economic Times' },
        ...
        { name: 'Manna (Southern Health Foods)', detail: 'Millet-based health foods, cereals, infant foods · Acquired by Reliance Consumer Products Feb 2026 · Source: Business Standard, Feb 10 2026' },
      ],
      alternatives: [{
    ...
    },
    {
      ...
      count: '4 brands',
      description: 'Netmeds (online pharmacy), Karkinos (cancer care), and Reliance Digital (electronics retail) extend Reliance reach into healthcare and consumer technology.',
      brands: [
        { name: 'Netmeds', detail: 'Online pharmacy · Acquired by Reliance 2020' },
        { name: 'Karkinos Healthcare', detail: 'Cancer care · AI-powered oncology platform · Acquired by Reliance Dec 2024 · Source: Business Standard, Dec 2024' },
